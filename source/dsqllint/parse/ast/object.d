...
module dsqllint.parse.ast.object;
...
interface SQLObject
{
	...
	@property bool hasBeforeComment();
	@property bool hasAfterComment();

	@property SQLCommentNode[] beforeComments();
	@property SQLCommentNode[] afterComments();
}

interface SQLObjectWithDataType
{
	// @property SQLDataType dataType();
	// @property void dataType(SQLDataType dataType);
}
