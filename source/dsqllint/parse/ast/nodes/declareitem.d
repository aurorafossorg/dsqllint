...
module dsqllint.parse.ast.nodes.declareitem;
...
import dsqllint.parse.ast.nodes.statement.tableelement;
import dsqllint.parse.ast.nodes.datatype.idatatype;

import aurorafw.stdx.exception;

public class SQLDeclareItemNode
	: SQLBaseNode, SQLObjectWithDataType
{
	public this()
	{
	...
	protected SQLTableElement[] tableElementList;
