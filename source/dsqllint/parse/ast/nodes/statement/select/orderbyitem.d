...
module dsqllint.parse.ast.nodes.statement.select.orderbyitem;

import dsqllint.parse.ast.models.replacable;
import dsqllint.parse.ast.nodes.base;
import dsqllint.parse.ast.nodes.expression;
import dsqllint.parse.ast.models.orderspec;

import aurorafw.stdx.exception;

public class SQLSelectOrderByItemNode
	: SQLBaseNode, SQLReplaceable
{
	public this()
	{
	...
	bool replace(SQLExpression src, SQLExpression dest)
	{
		throw new NotImplementedException("TODO:");
	}
