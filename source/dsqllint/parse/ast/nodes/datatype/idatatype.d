...
module dsqllint.parse.ast.nodes.datatype.idatatype;
...
public interface SQLDataType : SQLObject {
	...
	// @property long nameHashCode64();

	// @property SQLExpression[] arguments();

	// @property bool withTimeZone();
	// @property void withTimeZone(bool value);

	// @property bool withLocalTimeZone();
	// @property void withLocalTimeZone(bool value);
