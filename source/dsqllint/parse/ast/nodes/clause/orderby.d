...
module dsqllint.parse.ast.nodes.clause.orderby;

import dsqllint.parse.ast.nodes.base;
import dsqllint.parse.ast.nodes.statement.select.orderbyitem;

import aurorafw.stdx.exception;

public class SQLOrderByNode : SQLBaseNode
{
	public this()
	{
	...
	protected SQLSelectOrderByItemNode items;
